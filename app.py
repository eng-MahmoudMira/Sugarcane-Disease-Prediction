        ...
        st.markdown(
            ...
            <table style="width:100%; table-layout: fixed; border:none; border-spacing:0;">
                <tr style="border:none;">
                    <td style="border:none;"><a href="https://www.linkedin.com/in/-mahmoudmira-/" target="_blank" style="text-decoration:none;"><img src="Members/Mahmoud%20Mira.jpg" alt="Mahmoud Mira" style="max-width:100%; border:none; border-radius:85px; height:auto;"></td>
                    <td style="border:none;"><a href="https://www.linkedin.com/in/farah-bassiony-541930250/" target="_blank" style="text-decoration:none;"><img src="Members/Farah%20Bassiony.jpeg" alt="Farah Bassiony" style="max-width:100%; border:none; border-radius:85px; height:auto;"></td>
